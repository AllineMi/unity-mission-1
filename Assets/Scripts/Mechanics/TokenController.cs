...
namespace Platformer.Mechanics
{
    ...
    /// This allows a single update call to animate hundreds of sprite animations.
    /// If the tokens property is empty, it'll automatically find and load all token instances in the scene at runtime.
    /// </summary>
